        ...
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <button
              ...
              className="inline-flex items-center justify-center rounded-full bg-white px-5 py-3 text-sm font-bold text-schoolBlueDark shadow-[0_18px_40px_rgba(20,58,123,0.14)] transition hover:-translate-y-0.5 hover:bg-[#f8fbff]"
            >
              Add Image
            </button>
          </div>
            ...
            >
              ...
              >
                <FallbackImage
                  ...
                  imgClassName={`h-full w-full ${tile.imageClass} ${index === 0 ? 'p-0 object-center' : ''}`}
                />
              </button>
            </div>
          ))}
        ...
        >
          <div className="relative max-h-[90vh] w-full max-w-6xl" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="overflow-hidden rounded-[28px] border border-white/20 bg-white shadow-[0_24px_60px_rgba(0,0,0,0.35)]">
              <img src={activeImage.src} alt="Gallery preview" className="max-h-[90vh] w-full object-contain" />
            </div>
          </div>
        </div>
      ) : null}
